// ============================================================
// yolov11_demo.cpp  --  YOLOv11 Object Detection
// Default Ultralytics YOLOv11 — anchor-free, float tensor output
// (no PPU post-processing). Same decode layout as stock YOLOv8.
// Usage: ./yolov11_demo [--model path] [--source video|camera] [--path file]
//                      [--conf 0.3] [--iou 0.45]
// ============================================================
...
public:
    explicit YOLOv11Detector(const DemoParams& p)
